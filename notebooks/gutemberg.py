...
def main():
    ...
    if data_struct not in ['list','dict']:
        ...
        word_list_dict_file = open('words_dict', 'rb')
    ...
    if args.count:
        ...
        if sorted_word_dict.items():
            print("The {} most frequent known words:".format(args.count))
        ...
        count  = 0
        if sorted_unknown_word_dict.items():
            print("The {} most frequent unknown words:".format(args.count))
